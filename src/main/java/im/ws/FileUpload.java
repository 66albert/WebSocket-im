...
public class FileUpload {
    ...
    public @ResponseBody
    String uploadFile(@RequestParam(value = "file", required = false) MultipartFile file, int userId, HttpServletRequest request) {
        ...
        try {
            ...
            uf.setSrc( "/sns/downLoadFile?downLoadPath=" + downLoadPath + "&fileName=" + fileName);
            upFile.setData(uf);
        } catch (Exception e) {
            e.printStackTrace();
        }
