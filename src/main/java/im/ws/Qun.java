...
import im.service.GroupService;
import im.service.GroupUserService;
import im.vo.SNSMData;
import im.vo.SNSMember;
...
public class Qun {
  ...
  private GroupService groupService;
	...
	public @ResponseBody String getSimpleMemberByGroupId(int groupId){
 		List<String> data = groupUserService.getSimpleMemberByGroupId(groupId);
	...
	public @ResponseBody String getByGroupId(int id){
		List<GroupUser> list = groupUserService.getByGroupIdList(id);
